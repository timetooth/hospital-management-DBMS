...
INSERT INTO appointments (appointment_id, patient_id, doctor_id, appointment_date, app_time, status)
VALUES (16, 6, 110, TO_DATE('2024-05-09', 'YYYY-MM-DD'), TIMESTAMP '2024-05-09 12:00:00', 'UPC');

INSERT INTO appointments (appointment_id, patient_id, doctor_id, appointment_date, app_time, status)
VALUES (17, 7, 103, TO_DATE('2024-05-08', 'YYYY-MM-DD'), TIMESTAMP '2024-05-08 13:00:00', 'UPC');

INSERT INTO appointments (appointment_id, patient_id, doctor_id, appointment_date, app_time, status)
VALUES (18, 8, 111, TO_DATE('2024-05-08', 'YYYY-MM-DD'), TIMESTAMP '2024-05-08 14:00:00', 'UPC');

INSERT INTO appointments (appointment_id, patient_id, doctor_id, appointment_date, app_time, status)
VALUES (19, 9, 109, TO_DATE('2024-05-08', 'YYYY-MM-DD'), TIMESTAMP '2024-05-08 15:00:00', 'UPC');

INSERT INTO appointments (appointment_id, patient_id, doctor_id, appointment_date, app_time, status)
VALUES (20, 10, 101, TO_DATE('2024-05-08', 'YYYY-MM-DD'), TIMESTAMP '2024-05-08 16:00:00', 'UPC');
...
INSERT INTO bills (bill_id, patient_id, date_bills, amount, bill_type, status)
VALUES (133, 3, TO_DATE('2024-05-08', 'YYYY-MM-DD'), 1700, 'Appointment','unpaid');

INSERT INTO bills (bill_id, patient_id, date_bills, amount, bill_type, status)
VALUES (134, 4, TO_DATE('2024-05-08', 'YYYY-MM-DD'), 1800, 'Appointment','paid');

INSERT INTO bills (bill_id, patient_id, date_bills, amount, bill_type, status)
VALUES (135, 5, TO_DATE('2024-05-08', 'YYYY-MM-DD'), 1900, 'Appointment','paid');
...
INSERT INTO bills (bill_id, patient_id, date_bills, amount, bill_type, status)
VALUES (139, 5, TO_DATE('2024-05-08', 'YYYY-MM-DD'), 2300, 'Appointment','paid');

INSERT INTO bills (bill_id, patient_id, date_bills, amount, bill_type, status)
VALUES (140, 10, TO_DATE('2024-05-08', 'YYYY-MM-DD'), 2400, 'Appointment','unpaid');
